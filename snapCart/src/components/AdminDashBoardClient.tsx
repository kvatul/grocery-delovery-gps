...
function AdminDashBoardClient({ earning, stats, chartData }: propsType) {
    ...
    <div className="pt-28 w-[90%] md:w-[80%] mx-auto">
      ...
      >
        <motion.h1
          ...
          className="text-3x1 md:text-4x1 font-bold text-green-700"
        >
          🏬 Admin Dashboard
        </motion.h1>
        <select
      ...
      <motion.div
        ...
        className="bg-green-50 border border-green-200 shadow-sm rounded-2xl p-6 text-center"
      >
        ...
        {stats.map((s, i) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white border border-gray-100 shadow-md rounded-2xl p-5 mt-5
